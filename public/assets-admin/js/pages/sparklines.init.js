...
$(document).ready(function () {
    function e() {
        ...
        $("#sparkline1").sparkline([20, 40, 30], {
            ...
            (r = getChartColorsArray("#sparkline2")),
            ...
            (r = getChartColorsArray("#sparkline3")),
            ...
            (r = getChartColorsArray("#sparkline4")),
            ...
            (r = getChartColorsArray("#sparkline5")),
            ...
            (r = getChartColorsArray("#sparkline6")),
            $("#sparkline6").sparkline(
                [
                    4, 6, 7, 7, 4, 3, 2, 1, 4, 4, 5, 6, 3, 4, 5, 8, 7, 6, 9, 3,
                    2, 4, 1, 5, 6, 4, 3, 7,
                ],
                { type: "discrete", width: "280", height: "200", lineColor: r }
            ),
            (r = getChartColorsArray("#sparkline7")),
            ...
            (r = getChartColorsArray("#sparkline8")),
            ...
            (r = getChartColorsArray("#sparkline9")),

        ...
        function (t, e, o) {
            ...
            function i(t, e, o, n, i = {}) {
                e instanceof HTMLCollection || e instanceof NodeList
                    ...
                    Array.isArray(o) || (o = [o]);
                for (const r of e)
                    for (const e of o) r[t](e, n, { capture: !1, ...i });
            ...
            function S(t = {}) {
                ...
                const e = r(t.elements, "click", (e) => {
                    t.elements.forEach((o) =>
                        o.classList[e.target === o ? "add" : "remove"](
                            t.className
                        )
                    ),
                        t.onchange(e),
            ...
            const O = {
                ...
                E = (t, e, o) => {
                    ...
                    return {
                        update(t = n) {
                            const { reference: e, popper: o } = Object.assign(
                                n,
                                t
                            );
                            if (!o || !e)
                            ...
                            return ((t, e, o) => {
                                ...
                                return (
                                    (e.style.left = l), (e.style.top = c), null
                                );
                            })(e, o, n);
                        },
                    };
            ...
            class x {
                constructor(t) {
                    L(this, "_initializingActive", !0),
                        ...
                        (this.options = t =
                            Object.assign({ ...x.DEFAULT_OPTIONS }, t));
                    const {
                        swatches: e,
                        components: o,
                        theme: n,
                ...
                _buildComponents() {
                    const t = this,
                        ...
                        r = () =>
                            this._color ||
                            (this._color = this._lastColor.clone()),
                        s = {
                            palette: $({
                                element: t._root.palette.picker,
                                wrapper: t._root.palette.palette,
                                onstop: () =>
                                    t._emit("changestop", "slider", t),
                                onchange(o, n) {
                                    if (!e.palette) return;
                                    const i = r(),
                                        { _root: s, options: a } = t,
                                        { lastColor: l, currentColor: c } =
                                            s.preview;
                                    t._recalc &&
                                        ((i.s = 100 * o),
                                        (i.v = 100 - 100 * n),
                ...
                _bindEvents() {
                    ...
                    if (e.adjustableNumbers) {
                        ...
                        u(t.interaction.result, (t, o, n) => {
                            const i =
                                e[this.getColorRepresentation().toLowerCase()];
                            if (i) {
                                const e = i[n],
                                    r = t + (e >= 100 ? 1e3 * o : o);
                                return r <= 0
                ...
                _rePositioningPicker() {
                    ...
                    if (!t.inline) {
                        if (
                            ...
                            (t.style.top =
                                (window.innerHeight - e.height) / 2 + "px"),
                                (t.style.left =
                                    (window.innerWidth - e.width) / 2 + "px");
                        }
                    }
                }
                _updateOutput(t) {
                ...
                setColor(t, e = !1) {
                    ...
                    if (o) {
                        const t = n.toUpperCase(),
                            ...
                            r = i.find(
                                (e) => e.getAttribute("data-type") === t
                            );
                        if (r && !r.hidden)
                            for (const t of i)
                                t.classList[t === r ? "add" : "remove"](
                                    "active"
                                );
                        return (
                            !!this.setHSVA(...o, e) &&
